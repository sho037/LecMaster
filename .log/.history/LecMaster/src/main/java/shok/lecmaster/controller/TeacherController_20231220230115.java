...
public class TeacherController {
  ...
  public String each_lecture_setting(@RequestParam int id, @RequestParam int number, @RequestParam int eachlecture_id, ModelMap model) {
    ...
    model.addAttribute("id", id);
    model.addAttribute("eachlecture_id", eachlecture_id);
